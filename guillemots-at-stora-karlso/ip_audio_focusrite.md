...
| **Cable Glands (Weatherproof Entry/Exit)**          | Varies   | 5 - 20 per gland      | 20 - 100              | Price per gland, depends on size and type. Fewer glands needed for 4-mic setup and server not in enclosure.                                                                                                                                                                                                                                                                                              |
